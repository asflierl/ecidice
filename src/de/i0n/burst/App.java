...
public class App {
     ...
     */
    public void init() {
        final StandardGame game = new StandardGame(localize(Application.AppName));
        ...
        try {
            ...
            logger.log(Level.INFO, "game startup interrupted", exc);
            System.exit(1);
        }
    ...
    private class FallbackHandler implements Thread.UncaughtExceptionHandler {        
        ...
        public void uncaughtException(Thread thread, Throwable thrown) {
            logger.log(Level.SEVERE, "uncaught exception in thread " + thread, thrown);
            System.exit(1);
        }
    }
}
